    ...
    <section className="overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--panel)]">
      <div className="grid md:grid-cols-[1fr_1fr_1.15fr]">
        ...
        <div className="bg-emerald-300/[0.045] p-6">
          <p className="text-sm text-[var(--muted)]">Actual vs. expected passing</p>
      ...
      <p className="border-t border-[var(--border)] px-6 py-4 text-sm leading-6 text-[var(--muted)]">Actual pass completion compared with the model&apos;s expected completion.</p>
    </section>
  );
}
