...
export default async function ModelPage() {
  ...
  return (
      <main className="mx-auto min-h-screen max-w-7xl space-y-14 px-5 py-10 sm:px-8 sm:py-14">
        ...
        <p className="-mt-10 flex flex-wrap gap-4 text-sm"><Link href="/model/xg" className="text-[var(--accent)] hover:text-[var(--accent-strong)]">Expected Goals model →</Link><Link href="/model/action-value" className="text-[var(--accent)] hover:text-[var(--accent-strong)]">Attacking Value model →</Link></p>
