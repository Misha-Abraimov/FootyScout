        ...
        <div className="mx-auto max-w-7xl space-y-20 px-5 py-14 sm:px-8 sm:py-20">
          ...
          <section aria-labelledby="leaderboard-preview-heading">
            <div className="mb-6 flex items-end justify-between gap-4">
              <div><p className="text-xs font-semibold tracking-[0.16em] text-[var(--accent)] uppercase">Reliable samples</p><h2 id="leaderboard-preview-heading" className="mt-2 text-2xl font-semibold">Passing vs. expected</h2></div>
